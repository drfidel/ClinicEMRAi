...
import { LucideIcon, LayoutDashboard, Users, Calendar, Stethoscope, FlaskConical, Pill, Receipt, BarChart3, Settings, LogOut, Camera, ShieldAlert, Wallet, UserCheck } from 'lucide-react';
...
export const Sidebar = ({ currentTab, setTab }: { currentTab: string, setTab: (tab: string) => void }) => {
  ...
  const menuItems = [
    ...
    { id: 'users', label: 'User Admin', icon: UserCheck, roles: ['ADMIN'] },
